...
class MenosVisitasItems extends StatefulWidget {
  const MenosVisitasItems({Key? key}) : super(key: key);

  @override
  State<MenosVisitasItems> createState() => _MenosVisitasItemsState();
}

class _MenosVisitasItemsState extends State<MenosVisitasItems> {
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appbar(
            size, 'MENOS VISTOS', context, true, '/productosMenosVisitas'),
        drawer: MenuLateral(),
        body: Container(
          decoration: fondo(),
          child: Column(

...
class MasVisitasItems extends StatefulWidget {
  const MasVisitasItems({Key? key}) : super(key: key);

  @override
  State<MasVisitasItems> createState() => _MasVisitasItemsState();
}

class _MasVisitasItemsState extends State<MasVisitasItems> {
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appbar(size, 'MAS VISTOS',context,true,'/productosMasVisitas'),
        drawer: MenuLateral(),
         body: Container(
          decoration: fondo(),
          child: Column(

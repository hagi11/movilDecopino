...
Color color6 = Color.fromARGB(255, 153, 128, 119);
...
class MasVentasItems extends StatefulWidget {
  const MasVentasItems({Key? key}) : super(key: key);

  @override
  State<MasVentasItems> createState() => _MasVentasItems();
}

class _MasVentasItems extends State<MasVentasItems> {
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar:
            appbar(size, 'MAS VENDIDOS', context, true, '/productosMasVentas'),
        drawer: MenuLateral(),
        body: Container(
          decoration: fondo(),
          child: Column(
